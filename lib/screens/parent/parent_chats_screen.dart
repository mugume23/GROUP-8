...
class ParentChatsScreen extends StatelessWidget {
  final String userId;

  const ParentChatsScreen({super.key, required this.userId});
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<List<ChatModel>>(
              stream: chatService.getUserChats(userId, 'parent'),
                            ...
                            Stack(
                              children: [
                                CircleAvatar(
                                  ...
                                  backgroundImage: chat.caregiverImage != null
                                      ? NetworkImage(chat.caregiverImage!)
                                      : null,
                                  child: chat.caregiverImage == null
                                      ? Text(
                                          chat.caregiverName.isNotEmpty
                                              ? chat.caregiverName[0]
                                                  .toUpperCase()
                                              : '?',
